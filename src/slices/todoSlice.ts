...
export const taskSlice = createSlice({
  ...
  initialState,
  reducers: {
    setEditedTask: (state: { editedTask: EditTask; }, action: PayloadAction<EditTask>) => {
      state.editedTask = action.payload;
    },
    resetEditedTask: (state: { editedTask: EditTask; }) => {
      state.editedTask = initialState.editedTask;
    },
    setEditedTag: (state: { editedTag: Tag; }, action: PayloadAction<Tag>) => {
      state.editedTag = action.payload;
    },
    resetEditedTag: (state: { editedTag: Tag; }) => {
